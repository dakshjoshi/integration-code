...
// const DistributorAPI = require('../abi/distributor');
// const NXMTokenAPI = require('../abi/NXMToken');
// const NXMasterAPI = require('../abi/NXMaster');
// const TokenControllerAPI = require('../abi/TokenController');

// const Distributor = new web3.eth.Contract(
//   DistributorAPI,
//   0x2a1c103351edffb18c4013fedb01253ce8979348
// );

// const NXMToken = new web3.eth.Contract(
//   NXMTokenAPI,
//   0xF2e86Ac0c17A7A1431B95cFEaD37E15631cC5ee7
// );

// const NXMaster = new web3.eth.Contract(
//   NXMasterAPI,
//   0x2561D7f2436C121281388ecd54c702e55Aa24043
// );

// const TokenController = new web3.eth.Contract(
//   TokenControllerAPI,
//   0x2a1c103351edffb18c4013fedb01253ce8979348
// );
...
App.get("/buy", async (req, res) => {
  async function run() {
    ...
    const tokenController = await TokenController.at(
