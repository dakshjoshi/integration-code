export const NXMMaster = [
  ...
  {
    constant: true,
    inputs: [{ internalType: "bytes2", name: "_contractName", type: "bytes2" }],
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: "bytes2[]", name: "_contractsName", type: "bytes2[]" },
      {
        internalType: "address payable[]",
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: "bytes2[]", name: "_contractNames", type: "bytes2[]" },
      {
        internalType: "address[]",
        name: "_contractAddresses",
        type: "address[]",
